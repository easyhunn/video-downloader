<template>
  <div class="menu-side-bar " v-bind:class="{ minimize: isMinimize }">
    <!--logo trang cukcuk-->
    <div class="logo-site" style="border-bottom: 1px solid #F3F4F6;">
      <a href="../" tooltips="  " class="item-content">
        <div
          class=" w-5/6 h-100 d-flex align-item-center justify-content-center text-green-500 text-base"
        >
          Downloader
        </div>
      </a>
